...
typedef enum{d_integer, d_float32, d_bool, d_str, d_no_type}type;

typedef enum{d_var, d_stat}vod_type;

typedef enum{d_or, d_and, d_pl, d_min, d_star, d_div, d_mod, d_lt, d_gt, d_eq, d_ne, d_le, d_ge}op_type;

typedef enum{d_assign, d_if, d_for, d_stat_list, d_return, d_func, d_parse, d_print}stat_type;

typedef enum{d_not, d_minus, d_plus}non_assoc_type;

typedef enum{d_math, d_non_assoc, d_fun_inv, d_int, d_float, d_char}expr_type;

typedef enum{d_expr, d_strlit} print_type;
